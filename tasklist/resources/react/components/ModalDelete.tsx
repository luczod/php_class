...
function ModalDelete({ isModalDeleteOpen, setIsModalDeleteOpen, modalDeleteTaskId, reloadTasks }) {
    ...
    <Modal open={isModalDeleteOpen} onClose={() => setIsModalDeleteOpen(false)} center>
      <div className="modal-content">
        ...
        <div className="modal-actions">
          ...
          <button className="modal-btn modal-btn-submit" onClick={submitTaskDelete}>
            Yes
          </button>
        </div>
      </div>
