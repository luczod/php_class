...
<div id="event-create-container" class="col-md-6 offset-md-3">
  ...
  <form action="/events" method="POST"  enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input id="title" type="text" class="form-control"  name="title" placeholder="Event Name">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input id="city" type="text" class="form-control"  name="city" placeholder="Event location">
    </div>
    <div class="mb-3">
